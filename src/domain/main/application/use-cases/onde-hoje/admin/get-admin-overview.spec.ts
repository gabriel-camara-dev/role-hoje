...
import { GetAdminOverviewUseCase } from './get-admin-overview';
...
describe('Get Admin Overview', () => {
  ...
  it('returns the overview for an admin', async () => {
    ...
    expect((result as { value: { overview: unknown } }).value.overview).toBe(dashboardRepository.overview);
  });
